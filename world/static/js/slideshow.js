$(document).ready(
  function(){
    ...
    $("#slider").prepend('<div style="width:450px; height:450px;position:absolute; z-index:99" id="fmask"></div>');
  ...
  function playAnim(){
      ...
      $('#fmask').animate({width:($('#slider').width()), height: ($('#slider').width())}, 1000, function(){
